...
class Session{public static function init(){session_start();}
	 ...
	 public static function checkAdminOrUserLogin(){
	 	...
	 	if (self::get("login") == true) {
	 		if (self::get("adminLogin") == true) {
	 			...
	 			header("Location:/ems/employee/index.php");
	 		}
	 	}
	 }
	 ...
	 public static function destroy(){session_destroy();header("Location:/ems/index.php");
	 }

	  public static function checkAdminSession(){
	 	self::init();
	 	if (self::get("adminLogin") == false) {self::destroy();header("Location:/ems/index.php");
	 	}
	 }
	 ...
	 public static function unsetUser(){
	  ...
	  public static function checkAdminRolePermission(){
		 	...
		 	if (self::get("loggedRole") != 2 && self::get("loggedRole") !=3 ) {
		 		header("Location:/ems/admin/404.php");
		 	}
		 } 
