...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<td> <button type="button" class="btn btn-rounded btn-danger deleteClient" id="'.$row["id"].'"><i class="fa fa-trash" aria-hidden="true"></i></button>
		<button type="button" class="btn btn-rounded btn-info editClient" id="'.$row["id"].'"><i class="far fa-edit" aria-hidden="true"></i></button>
