...
<div class="row m-2">
  ...
  <form class="form--wizard" method="post" id="addEmployeeForm" enctype="multipart/form-data" autocomplete="off" onSubmit="return validation();">       
    ...
    <div class="form-group">
    <label for="password" class="col-sm-4 control-label font-weight-bold">Password:</label>
    <div class="col-sm-6">
   ...
   <input type="radio" name="gender" class="Gender" id="gender" value="2">Female
    ...
    <input type="radio" name="gender" class="Gender" id="gender" value="3">Others
      ...
      <div class="form-group">
      <label for="datepicker" class="col-sm-2 control-label font-weight-bold">DOB:</label>
      <div class="col-sm-6">
      ...
      <div class="form-group">
      <label for="address" class="col-sm-2 control-label font-weight-bold">Address:</label>
      <div class="col-sm-6">
      ...
      <!-- End col-sm-8  First Div-->
       <!-- col-sm-4 -->
                  <div class="col-sm-4">  
          <div class="form-group">
          <span for="file-inpu" class="col-sm-2 control-label font-weight-bold">Photo(JPG,JPEG,PNG,GIF)</span>
          <div class="col-sm-6">
