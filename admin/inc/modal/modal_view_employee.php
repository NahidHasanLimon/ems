 <!-- Modal -->
    <div class="modal fade " id="modal_view_employee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="">
        ...
        <div class="modal-dialog">
            ...
            <div class="card">
                    <center>
                        <p style="" id="noJobMessage"><h2> No Current Job</h2></p>
                    </center>
                    <div class="table-responsive" id="jobDetailsDiv" style="display: none;"> 
                  <p id="jobShowingTitle"><strong>Current Job </strong></p>
                    <p style="display: none;" class="text-left " id="EmployeeJobDetails"></p><table class="table-responsive table-bordered" id="jobDetailsTable"> 
                            <thead>
                            ...
                            <tbody id="jobDetailsTableBody"></tbody>
                    ...
                    <center>
                    <button class="btn btn-primary SeeAllJobsBtn" id="15" name="allJobsBtn"> See All Jobs</button>
                    <br>
                    </center>
                </div>
                <!-- end of card -->
