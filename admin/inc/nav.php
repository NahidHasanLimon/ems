...
<header class="navbar navbar-fixed">
            ...
            <div class="navbar--header">
                ...
                <a href="<?php echo $baseUrl.'admin/index.php' ?>" class="logo">
                    ...
                    <!-- <img src="<?php echo $baseUrl?>/assets/img/customLogo_95by25.png" alt=""> -->
                ...
                <?php }
                  ...
                  ?>   
                    ...
                    <li class="nav-item dropdown nav--user online">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo $baseUrl.'admin/'?>v_profile.php"><i class="far fa-user"></i>Profile</a></li>
                            <li><a href="<?php echo $baseUrl.'admin/'?>v_logged_attendance_details.php"><i class="far fa-calendar"></i>Attendance Details</a></li>
