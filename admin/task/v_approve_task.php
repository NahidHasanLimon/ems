...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/ems/admin/inc/sidebar.php') ?>
        ...
        <main class="main--container">
            ...
            <section class="main--content">
                <!-- mycode -->
                <div class="container">
                <table class="table responsive table-striped table-dark table table-borderless text-center" id="unapprovedTasksTable">
                           ...
                           <button type="button" class="btn btn-rounded btn-primary float-right m-5" id="approve_allTasksBtn"><i class="fa fa-paper-plane" aria-hidden="true"></i>Approve all</button> 
              </div>
 ...
 <?php include_once($_SERVER['DOCUMENT_ROOT'].'/ems/admin/inc/scripts.php') ?>
  ...
  function fetch_data()
  {
   var dataTable = $('#unapprovedTasksTable').DataTable({
    "processing" : true,
    "serverSide" : true,
    "order" : [],
     "ordering": false,
    ...
    "ajax" : {
     url:"../controller/task/unapproved_tasks_fetch.php",
     type:"POST"
    }
   });
  }
    ...
    $(document).on('click', '.approveTask', function(){
        ...
        title: "Success!",text: 'Project Approved Successfully',icon: "success",closeOnClickOutside: false,
                      ...
                      dangerMode: false,
                          ...
                          $('#unapprovedTasksTable').DataTable().destroy();
                            fetch_data();
                        }); 
                      } 
