 ...
 <form action="" method="post" id="updateProfileForm" enctype="multipart/form-data" autocomplete="off" onSubmit="return validation();">    
  ...
  <input type="hidden" value="<?php echo $emp_id ?>" name="employee_id">   
    ...
    <div class="col-sm-8">
     ...
     <!-- Form Group Start -->
                                <div class="form-group">
                                    <span class="col-sm-4 control-label font-weight-bold">Gender</span>

                                    <div class="col-md-10 form-inline">
                                        <label class="form-radio mr-3">
                                            <input type="radio" name="gender" value="1" class="form-radio-input" <?php if($row['gender']==1)echo 'checked' ?>>
                                            <span class="form-radio-label">Male</span>
                                        </label>

                                        <label class="form-radio">
                                            <input type="radio" name="gender" value="2" class="form-radio-input "<?php if($row['gender']==2)echo 'checked' ?>>
