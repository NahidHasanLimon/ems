...
<?php $pageSlug="monthly-attendance-report"; ?>
...
{ ?>
             ...
             <th class="text-center s">Presents</th>
              ...
              <th class="text-center ">working_Days</th>
               <th class="text-center">Actions</th>
                    </tr>
                  </tfoot>
                  <tbody>
  ...
  ?>
      ...
      <tr>
       ...
       <td class="text-center" style="font-weight:900"><?php echo  $row['MeetingLate']; ?></td>
        ...
        <td class="text-center" style="font-weight:900"><?php echo  $row['Total_working_Days']; ?></td>
