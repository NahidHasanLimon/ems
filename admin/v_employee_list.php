...
<?php $resultEmployeeList=$usr->current_jobs_endDateisNull_all_employee_details();  ?>
<!DOCTYPE html>
        ...
        <th scope="row" class="text-info align-middle name_modal" style="min-width: 150px; ">
          <a href="#" class="view_emp_modal"id="<?php echo $row['emp_id'] ?>"><?php echo  $row['first_name']." ".$row['last_name'] ?><a href="#">
              ...
              <form action="v_all_employee_list.php" method="post">
                 ...
                 <input type="submit" name="viewAllEmployee" class="btn btn-info bg-gradient-success text-gray-100 seeAllEmployee" id="seeAllEmployee" value="See All Employee" >
              </form>
