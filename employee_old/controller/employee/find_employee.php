    ...
    while($row =$find_employee_by_company_department_designation->fetch_assoc()){ 
      ...
      $output= '
                     ...
                     <td>' . $row["first_name"] .' '.$row['last_name'].'</td>  
                          <td><input type="button" name="View" value="View" id="' . $row["emp_id"] . '" class="btn btn-danger btn-xs viewEmployeesData" /></td>  
                          <td><a href="v_edit_employee.php?emp_id='.$row['emp_id'].'" type="button" name="View" id="' . $row["emp_id"] . '" class="btn btn-primary btn-xs editEmployeesData" role="button">Edit</a></form></td>  
                     </tr>  
                ';  
                 echo $output; 
