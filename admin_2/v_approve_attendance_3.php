...
<!-- End of Sidebar -->
  ...
  <li style="text-align:center; display:inline-block; padding:0.1em 1em">
                  <a ><?php echo $rowunApprovedeDate['at_date']; ?></a>  
                </li> -->
         <ul style=" margin:0.5em auto;">
         <?php
  ...
  <!-- Display Choosen Month  -->
        ...
        <span class="error_response" id="error_response" style="display: none;">***</span>
            <div class="form-check form-check-inline float-right">
              ...
              <input class="form-control btn btn-primary mr-2" type="button" name="update_button_3" value="Update" id="update_button_3" >
                 <input class="form-control btn btn-success" type="button" name="approve_button_3" value="Approve" id="approve_button_3" >
