...
<?php include_once($_SERVER['DOCUMENT_ROOT'].'/ems/employee/inc/sidebar.php') ?>
        ...
        <main class="main--container">
            ...
            <section class="main--content">
                <!-- mycode -->
                <div class="container">
                <table class="table responsive table-striped table-dark table table-borderless text-center" id="myAllTasksTable">
 ...
 <?php include_once($_SERVER['DOCUMENT_ROOT'].'/ems/employee/inc/scripts.php') ?>
  ...
  function fetch_data()
  {
   var dataTable = $('#myAllTasksTable').DataTable({
    "processing" : true,
    "serverSide" : true,
    "order" : [],
     "ordering": false,
    ...
    "ajax" : {
     url:"../controller/task/my_all_task_fetch.php",
     type:"POST"
    }
   });
  }
